...
public class Delete_Order extends JFrame implements ActionListener{
	...
	add(l9);
			...
			try {
				...
				String query = "SELECT orderID, name, age, gender, brand, model, availability, location, status FROM orders";
		...
		public void actionPerformed(ActionEvent e) {
		    if (e.getSource() == Back) {
				...
				try {
					DBConnection c = new DBConnection();
					String query = "delete from orders where orderID = '"+id.getSelectedItem()+"'";
					c.s.executeUpdate(query);
					
					JOptionPane.showMessageDialog(null, "Orders Record Deleted Successfully");
